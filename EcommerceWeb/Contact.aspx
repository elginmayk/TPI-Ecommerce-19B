...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main aria-labelledby="title">
        ...
        <address>
            ...
            General Pacheco, Buenos Aires<br/>
              Argentina<br/>
        ...
        <address>
            <strong>Support:</strong>   <a href="mailto:Support@example.com">ccolomo@TheDibaStore.com.ar</a><br />
            <strong>Marketing:</strong> <a href="mailto:Marketing@example.com">mvalverde@TheDibaStore.com.ar</a>
        </address>
